...
type [<AllowNullLiteral>] [<MenuAttribute("Разрешения", PermissionNamesForFodels.PermissionView, Sections.Administration, "Permission", Icons.Admin)>] Permission private () =
